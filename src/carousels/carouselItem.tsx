...
import type { SLIDES } from "./const";

export const VideoSlideItem: FC<{
    ...
    >
      ...
      <div className="relative h-full flex flex-col justify-between p-6 text-white">
        <div className="flex justify-center items-center flex-1">
          {slide.mediaType !== "video" && (
            <div
              className={`w-16 h-16 bg-red-600 rounded-2xl flex items-center justify-center shadow-lg transform transition-all duration-300 `}
            >
